...
DYNAMIC-FUNCTION('btTracesTracerMessage', INPUT ?, INPUT ?, INPUT 0, INPUT "SERVEUR", INPUT "<== bs00acti.p - executing=" + QUOTER(SESSION:CURRENT-REQUEST-INFO:ProcedureName) + ", btGetModeExecution=" + QUOTER(DYNAMIC-FUNCTION('btGetModeExecution')) + ", session-free=" + QUOTER(ll_sessionFree) + ", IdUtilWindows=" + QUOTER(lc_idUtilWindows) + ", btGetConnectContext=" + QUOTER(SESSION:SERVER-CONNECTION-CONTEXT) + ", serverConnectionBound=" + QUOTER(SESSION:SERVER-CONNECTION-BOUND) + ", serverOperatingMode=" + QUOTER(SESSION:SERVER-OPERATING-MODE) + ", serverConnectionId=" + QUOTER(SESSION:SERVER-CONNECTION-ID ) + ", serverConnectionBoundRequest=" + QUOTER(SESSION:SERVER-CONNECTION-BOUND-REQUEST) + ", executing=" + QUOTER(SESSION:CURRENT-REQUEST-INFO:ProcedureName) + ", session-free=" + QUOTER(ll_sessionFree) + ", sessionId=" + QUOTER(SESSION:CURRENT-REQUEST-INFO:SessionId) + ", adapterType=" + QUOTER(SESSION:CURRENT-REQUEST-INFO:AdapterType) + ", ctxId=" + QUOTER(SESSION:CURRENT-REQUEST-INFO:ClientContextId) + ", btGetConnectContext=" + QUOTER(SESSION:SERVER-CONNECTION-CONTEXT)).
